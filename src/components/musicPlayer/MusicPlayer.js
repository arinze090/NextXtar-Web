...
const IconWrapper = styled.div`
  ...
  /* Tooltip styles */
  &:hover::after {
    content: attr(data-title); /* Tooltip text comes from this attribute */
    position: absolute;
    ...
    <>
      {isAudioPlayingData && (
        <PlayerContainer>
          ...
          <ControlsSection>
            <Controls>
              <IconWrapper data-title="Shuffle" onClick={handleShuffle}>
                <ShuffleIcon
                  style={{
              ...
              <IconWrapper data-title="Previous" onClick={playPreviousTrack}>
                <SkipBackIcon />
              </IconWrapper>
              ...
              <PlaySection onClick={handlePlayPause}>
                {isAudioPlaying ? (
                  ...
                  <IconWrapper data-title="Play">
                    <PlayIcon />
                  </IconWrapper>
                )}
              </PlaySection>
              <IconWrapper data-title="Next">
                <SkipForwardIcon
                  onClick={playNextTrack}
                  isDisabled={isLastTrack}
                />
              </IconWrapper>
              <IconWrapper data-title="Repeat" onClick={toggleRepeat}>
                <RepeatIcon
                  style={{
